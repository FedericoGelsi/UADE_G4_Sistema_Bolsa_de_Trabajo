...
public class VentanaReporte extends JFrame {
	...
	private JTextField txtOfMasExg;
	...
	public VentanaReporte() {
		...
		JLabel lblMasExigentes = new JLabel("Reporte Oferta Laboral Mas Exigente");
		lblMasExigentes.setBounds(5, 5, 675, 16);
		contentPane.add(lblMasExigentes);

		JLabel lblMasExigentesResultado = new JLabel("");
		lblMasExigentesResultado.setBounds(5, 25, 675, 16);
		contentPane.add(lblMasExigentesResultado);

		txtOfMasExg = new JTextField();
		txtOfMasExg.setBounds(103, 100, 130, 44);

		JButton btnNewButton = new JButton("Obtener");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ReporteVO miReporte = miCoordinador.getReporteMasExigente();
				lblMasExigentesResultado.setText(miReporte.getTitulo_oferta());
			}
		});
